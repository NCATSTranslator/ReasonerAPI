...
| name | `string` | Human-readable name or label for the constraint concept. It SHOULD be the term name of the CURIE used as the 'id' and SHOULD NOT supersede the use of AttributeConstraint.id (which is required). This is redundant but required for human readability. |
| not | `boolean` |  |
