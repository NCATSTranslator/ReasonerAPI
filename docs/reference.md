...
#### Attribute [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1182:L1267)
...
#### Edge [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1268:L1350)
...
#### Qualifier [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1351:L1387)
...
#### QualifierSetConstraint [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1388:L1403)
...
#### BiolinkEntity [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1404:L1415)
...
#### CURIE [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1429:L1438)
...
`string`
#### MetaKnowledgeGraph [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1439:L1466)
...
#### MetaNode [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1467:L1490)
...
#### MetaEdge [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1491:L1555)
...
#### MetaQualifier [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1556:L1575)
...
#### AttributeConstraint [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1614:L1707)
...
#### RetrievalSource [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1708:L1765)
...
#### ResourceRoleEnum [↗](https://github.com/NCATSTranslator/ReasonerAPI/blob/2.0-specification-update/TranslatorReasonerAPI.yaml#L1766:L1777)
