...
| categories | Array\[[BiolinkEntity](#biolinkentity-)\] | **Minimum items: 1.** Biolink Model categories that are allowed to be of type 'abstract' or 'mixin' (only in QGraphs!). Use of deprecated categories SHOULD be avoided. |
